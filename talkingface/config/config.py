...
class DINetTrainingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--train_data', type=str, default=r"./asserts/training_data/training_json.json", help='path of training json')
        self.parser.add_argument('--batch_size', type=int, default=128, help='training batch size')
        ...
        self.parser.add_argument('--non_decay', default=500, type=int, help='num of epoches with fixed learning rate')
        self.parser.add_argument('--decay', default=500, type=int, help='num of linearly decay epochs')
        self.parser.add_argument('--checkpoint', type=int, default=100, help='num of checkpoints in training stage')
